...
#
# Writes: dist/gpoliceweaponsofjustice-<VERSION>-<artifact-tag>.zip
set -euo pipefail
...
exec bash "${PACKAGER}" \
  ...
  --zip-prefix gpoliceweaponsofjustice \
  --exe-name G_Police_Weapons_of_Justice \
  --omit-openbios \
  --display-name "G-Police: Weapons of Justice" \
  --recompiler-build "${RECOMPILER_BUILD}" \
  --version-env RELEASE_VERSION \
  --disc-hint "your legally owned G-Police: Weapons of Justice (USA) disc" \
  --runtime-dir mods \
