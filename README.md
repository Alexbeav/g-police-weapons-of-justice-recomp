...
[![GitHub downloads (all assets, all releases)](https://img.shields.io/github/downloads/Alexbeav/g-police-weapons-of-justice-recomp/total)](https://github.com/Alexbeav/g-police-weapons-of-justice-recomp/releases)
[![GitHub downloads (latest release)](https://img.shields.io/github/downloads/Alexbeav/g-police-weapons-of-justice-recomp/latest/total)](https://github.com/Alexbeav/g-police-weapons-of-justice-recomp/releases/latest)
[![GitHub release](https://img.shields.io/github/v/release/Alexbeav/g-police-weapons-of-justice-recomp)](https://github.com/Alexbeav/g-police-weapons-of-justice-recomp/releases/latest)
<!-- /retcomm-readme-metrics -->

Static recompilation of **G-Police: Weapons of Justice** built on
[psxrecomp](https://github.com/mstan/psxrecomp) and
[recomp-ui](https://github.com/RetroPortingToolKit/recomp-ui).

This is an owned-input setup kit. You supply your own SLUS-00798 disc image
...
|---|---|
| Region | USA |
| Disc serial | SLUS-00798 |
| Discs | 1 |
| Supported dump | Redump `G-Police - Weapons of Justice (USA).cue` as CUE/BIN or CHD |
| BIOS | SCPH-1001 (USA), 524288 bytes, SHA-256 `71af94d1e47a68c11e8fdb9f8368040601514a42a5a399cda48c7d3bff1e99d3` |

## Setup

1. Download the setup ZIP for your platform from [Releases](https://github.com/Alexbeav/g-police-weapons-of-justice-recomp/releases)
   and extract it into a writable folder.
2. Start `G_Police_Weapons_of_Justice` (`.exe` on Windows).
...
named `diagnostic-mode.txt` next to `G_Police_Weapons_of_Justice.exe` and start the game as
usual, or run `G_Police_Weapons_of_Justice.exe --diagnostic`. Reproduce the problem, quit, then
run `G_Police_Weapons_of_Justice.exe --collect-diagnostics`: it writes `diagnostics-<date>.zip`
