...
static const PsxrecompCodegenHostConfig kCodegenConfig = {
    .display_name = "G-Police: Weapons of Justice",
    .project_root_env = "G_POLICE_WEAPONS_OF_JUSTICE_PROJECT_ROOT",
    .build_dir_env = "G_POLICE_WEAPONS_OF_JUSTICE_BUILD_DIR",
    .force_setup_env = "G_POLICE_WEAPONS_OF_JUSTICE_FORCE_SETUP",
    .psxrecomp_cli_relpath = "psxrecomp/psxrecomp_cli.py",
    .seed_cfg_relpath = "game.toml",
    .game_toml_relpath = "game.toml",
    .gen_marker_relpath = "generated/SLUS_007.98_dispatch.c",
    .build_dir_name = "build-release",
    .cmake_target = "psx-runtime",
    .exe_basename = "G_Police_Weapons_of_Justice",
    .prepare_note =
